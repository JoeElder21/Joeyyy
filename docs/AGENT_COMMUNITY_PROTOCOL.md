...
- Activate the smallest evidence-justified team whose independent contributions materially change the result, and run independent work in parallel when it improves speed or coverage.
