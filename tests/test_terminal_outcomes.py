...
class OutcomeTests(unittest.TestCase):
    def test_reference_is_the_next_open_not_the_prior_close(self):
        reference = outcomes.tradable_reference(utc("2026-05-01T10:41:00"), ASSET)
        self.assertEqual((reference.price, reference.kind), (80.0, "open"))
        self.assertEqual(outcomes.tradable_reference(utc("2026-05-01T10:41:00"), ASSET[:1]), None)
    ...
    def test_long_hit_short_miss_and_open(self):
        hit = outcomes.evaluate(
            "BUY", utc("2026-05-01T10:41:00"), 90, ASSET, BENCH, utc("2026-09-01T00:00:00")
        )
        ...
        miss = outcomes.evaluate(
            "AVOID", utc("2026-05-01T10:41:00"), 90, ASSET, BENCH, utc("2026-09-01T00:00:00")
        )
        self.assertEqual(miss.status, outcomes.MISS)
        early = outcomes.evaluate(
            "BUY", utc("2026-05-01T10:41:00"), 90, ASSET, BENCH, utc("2026-06-01T00:00:00")
        )
    ...
    def test_void_without_a_tradable_reference(self):
        void = outcomes.evaluate(
            "BUY", utc("2026-05-01T10:41:00"), 30, [], BENCH, utc("2026-09-01T00:00:00")
        )
    ...
    def test_hold_is_a_hit_when_not_negative_on_either_measure(self):
        ...
        hold = outcomes.evaluate(
            "HOLD", utc("2026-05-01T10:41:00"), 90, flat, BENCH, utc("2026-09-01T00:00:00")
        )
        self.assertEqual(hold.status, outcomes.HIT)
        with self.assertRaises(ValueError):
            outcomes.evaluate(
                "YOLO", utc("2026-05-01T10:41:00"), 90, flat, BENCH, utc("2026-09-01T00:00:00")
            )
